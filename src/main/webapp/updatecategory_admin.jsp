...
<head>
<meta charset="UTF-8">
<title>Cập nhật doanh mục</title>
            ...
            <div id="layoutSidenav_content">
             <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Cập nhật doanh mục </h1>
                        <ol class="breadcrumb mb-4">
                          <li class="breadcrumb-item active"><a href="<%= request.getContextPath() %>/admin/dashboardAdmin">Thống kê</a><a href="<%= request.getContextPath() %>/admin/category">/Doanh mục</a>/Cập nhật</li>
                        </ol>     
                        <div class="container mt-4">
                          <div class="card">
                            <div class="card-header">Cập nhật tài khoản</div>
                            <form action="<%= request.getContextPath() %>/admin/category/update/${category.id}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                           
              <div class="mb-3">
                <label for="name" class="form-label">Tên doanh mục</label>
                <input type="text" class="form-control" id="name" name="name" value="${category.name}" placeholder="Nhập họ và tên" required>
              </div>
              <div class="mb-3">
